...
const ChannelList = ({ name, _id, isChatCurrent, setNewChat, hasUnreadMsg }) => {
  const dispatch = useDispatch()

  return (
    <div
      className={`flex items-center text-white font-semibold py-1 px-6 ${
        isChatCurrent
    ...
    >
      ...
      { hasUnreadMsg &&
              <svg
              className="h-6 w-6 mt-1 text-white fill-current animate-pulse"
              viewBox="0 0 32 32"
            >
              <g id="surface1">
